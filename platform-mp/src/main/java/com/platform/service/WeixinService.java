...
public class WeixinService extends WxMpServiceImpl {
    ...
    public void init() {
       ...
       /* // 设置微信公众号的appid
        ...
        // 设置微信公众号的appid
        config.setAppId("wx6fd7350ed39265c4");
        // 设置微信公众号的app corpSecret
        config.setSecret("9be6ca153c42de5d6fff811b65346fa1");
        // 设置微信公众号的token
        config.setToken("javen");
        // 设置消息加解密密钥
        config.setAesKey("ttDAKLKT9xhPTahlEiCvdDYlyXaqBLomkMhWGxnTysl");
